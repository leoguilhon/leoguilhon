...
Sou desenvolvedor com experiência prática em **RPA**, **integrações de sistemas** e **construção de APIs**, tendo trabalhado principalmente com **Python**, **SQL** e **Java** no desenvolvimento de soluções para automatizar rotinas corporativas e reduzir processos manuais em empresas como **Light**, **Americanas**, **White Martins** e **Weatherford**.
